...
# 自定义模块
from network import GCN, GIN, MLP_Encoder
...
def pretune(_run, dataloader_dir, train1_loader_type, train2_loader_type, unaug_loader_type,
    ...
    for i in range(cv_number):
        ...
        # gmlp_model = MLP_Encoder(in_feats=246, n_hidden=n_hidden, n_classes=2, n_layers=n_layers,
        ...
        # encoder_optimizer = torch.optim.Adam(gmlp_model.parameters(), lr=adam_learning_rate, weight_decay=adam_weight_decay)
